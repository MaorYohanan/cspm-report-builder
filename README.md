...
| `GEMINI_API_KEY` | _(empty)_ | Google Gemini API key for AI writing assistant (empty = disabled). Get one at [aistudio.google.com/apikey](https://aistudio.google.com/apikey) |
